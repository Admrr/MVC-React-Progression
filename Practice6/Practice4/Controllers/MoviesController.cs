...
namespace Practice4.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        [HttpPost("Filter")] // Filter/{} if you have parameters.
        public IActionResult Filtering([FromBody] Filter f) {
                var fp = MyExpressions.FilterToExpression<Movie>(f);
                var result = _context.Movies.Select(p => p).Where(fp).ToList();
